  ...
  describe('value', () => {
    describe('incValue', () => {
      ...
      it('should do no op if path is nil', () => {
        expect(composeReducer(incValue(null, 10))(0)).toEqual(0);
        expect(composeReducer(incValue(undefined, 10))(0)).toEqual(0);
        expect(composeReducer(incValue(() => null, 10))(0)).toEqual(0);
        expect(composeReducer(incValue(() => {}, 10))(0)).toEqual(0);
      });
