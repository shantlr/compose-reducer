  ...
  describe('value', () => {
    describe('popValues', () => {
      ...
      it('should do no op if path is nil', () => {
        expect(composeReducer(popValues(null, 0))([1, 2, 3])).toEqual([
          1,
          2,
          3
        ]);
        expect(composeReducer(popValues(undefined, 0))([1, 2, 3])).toEqual([
          1,
          2,
          3
        ]);
        ...
        expect(composeReducer(popValues(() => {}, 0))([1, 2, 3])).toEqual([
          1,
          2,
          3
        ]);
