  ...
  describe('value', () => {
    describe('pushValues', () => {
      ...
      it('should do no op if path is nil', () => {
        expect(composeReducer(pushValues(null, [1, 2, 3]))([])).toEqual([]);
        expect(composeReducer(pushValues(undefined, [1, 2, 3]))([])).toEqual(
          []
        );
        expect(composeReducer(pushValues(() => null, [1, 2, 3]))([])).toEqual(
          []
        );
        expect(composeReducer(pushValues(() => {}, [1, 2, 3]))([])).toEqual([]);
      });
